#!/usr/bin/env python3
# RETIRED 2026-08-04. This generator produces the OLD dark magnet template and
# would clobber the on-brand pages rebuilt in the W2 design wave (all 13 pages
# under free/*/ now use the site design system, real covers, Lead events, and
# System bridges). magnets.json remains as historical data. If magnet pages
# need regeneration, fold them into build.js the way the blog is built.
import sys
sys.exit("build_magnets.py is retired - the free/* pages are now hand-maintained on the site design system. See magnets/build_magnets.py header.")

# ----- original generator preserved below for reference, never executed -----
# #!/usr/bin/env python3
# """
